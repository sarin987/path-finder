...
// Import fileService using relative path to avoid circular dependencies
let fileService;
try {
  fileService = require('../../services/fileService');
} catch (error) {
  console.error('Error importing fileService:', error);
  throw new Error('Failed to initialize upload middleware: fileService not found');
}
