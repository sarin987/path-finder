...
LOCK TABLES `ambulance_drivers` WRITE;
/*!40000 ALTER TABLE `ambulance_drivers` DISABLE KEYS */;
/*!40000 ALTER TABLE `ambulance_drivers` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2025-04-27 13:19:02
