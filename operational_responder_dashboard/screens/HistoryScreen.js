  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.main}>
        ...
        <Text style={styles.subtitle}>All completed, rejected, or incomplete tasks will appear here.</Text>
        {/* TODO: Render history list/table here */}
      </View>
    </View>
  );
}
...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 24, fontWeight: 'bold', margin: 16, color: '#222e3a' },
